...
type StepMeta struct {
	...
	StepsTotal int32 `protobuf:"varint,4,opt,name=steps_total,json=stepsTotal,proto3" json:"steps_total,omitempty"`
...
func (x *StepMeta) GetStepsTotal() int32 {
	if x != nil {
		return x.StepsTotal
	}
	return 0
...
const file_pipelineinspector_proto_v1alpha1_pipeline_inspector_proto_rawDesc = "" +
	...
	"\x14EmitResponseResponse\"\xd3\x04\n" +
	"\bStepMeta\x12\x19\n" +
	"\btrace_id\x18\x01 \x01(\tR\atraceId\x12\x17\n" +
	"\aspan_id\x18\x02 \x01(\tR\x06spanId\x12\x1d\n" +
	"\n" +
	"step_index\x18\x03 \x01(\x05R\tstepIndex\x12\x1f\n" +
	"\vsteps_total\x18\x04 \x01(\x05R\n" +
	"stepsTotal\x12\x1c\n" +
